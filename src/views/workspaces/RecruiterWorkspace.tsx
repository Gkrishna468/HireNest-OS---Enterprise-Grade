        ...
        <div className="flex-1 bg-slate-50 flex flex-col min-h-screen text-slate-900 font-sans">
            ...
            <div className="bg-white border-b border-slate-200 px-8 py-8 relative overflow-hidden">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between relative z-10 gap-6">
                    <div>
                        <h1 className="text-3xl font-medium tracking-tight text-slate-900 mb-2">Good morning, {userName}</h1>
                        <p className="text-sm text-slate-500">Here is your daily action plan and pipeline summary.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <button className="bg-white hover:bg-slate-50 transition-colors border border-slate-200 p-4 rounded-xl flex items-center gap-4 group shadow-sm text-left">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-slate-500">Add to open requirement</p>
                                </div>
                            </button>
                            <button className="bg-white hover:bg-slate-50 transition-colors border border-slate-200 p-4 rounded-xl flex items-center gap-4 group shadow-sm text-left">
                                ...
                                <div>
                                    <h4 className="font-semibold text-slate-900 text-sm">Search Requirement</h4>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <div className="flex items-center justify-between">
                                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest">Today's Work</h3>
                            </div>
                            ...
                            <div className="pt-6">
                                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Pipeline Summary</h3>
