...
import { Briefcase, Users, Calendar, Clock, DollarSign, Target, Search, UserPlus, FileText, Sparkles } from "lucide-react";
        ...
        <div className="flex-1 bg-slate-50 flex flex-col min-h-screen text-slate-900 font-sans">
            ...
            <div className="bg-white border-b border-slate-200 px-8 py-8 relative overflow-hidden">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between relative z-10 gap-6">
                    <div>
                        <h1 className="text-3xl font-medium tracking-tight text-slate-900 mb-2">Vendor Dashboard</h1>
                        <p className="text-sm text-slate-500">Agency: <strong className="text-indigo-600">{vendorName}</strong> | Here is your placement pipeline.</p>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <button onClick={() => setSubmittingReq({ id: "quick-submit", title: "Quick Submission" })} className="bg-white hover:bg-slate-50 transition-colors border border-slate-200 p-4 rounded-xl flex items-center gap-4 group shadow-sm text-left">
                                <div className="bg-indigo-50 text-indigo-600 p-3 rounded-lg group-hover:bg-indigo-100 transition-colors">
                                    <UserPlus size={20} />
                                </div>
                                <div>
                                    <h4 className="font-semibold text-slate-900 text-sm">Submit Candidate</h4>
                                    <p className="text-xs text-slate-500">Float your bench candidates</p>
                                </div>
                            </button>
                            <button className="bg-white hover:bg-slate-50 transition-colors border border-slate-200 p-4 rounded-xl flex items-center gap-4 group shadow-sm text-left">
                                ...
                                <div>
                                    <h4 className="font-semibold text-slate-900 text-sm">Search Open Jobs</h4>
                                    <p className="text-xs text-slate-500">Browse allocated requirements</p>
                                </div>
                            </button>
                            <button className="bg-white hover:bg-slate-50 transition-colors border border-slate-200 p-4 rounded-xl flex items-center gap-4 group shadow-sm text-left">
                                ...
                                <div>
                                    <h4 className="font-semibold text-slate-900 text-sm">Submit Invoice</h4>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            <div className="flex items-center justify-between">
                                <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest">Active Operations</h3>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between hover:border-slate-300 transition-colors cursor-pointer">
                                    ...
                                    <h4 className="font-semibold text-slate-900 text-sm">Allocated Requirements</h4>
                                    <p className="text-xs text-slate-500 mt-1">Open jobs available for you</p>
                                </div>
                                ...
                                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between hover:border-slate-300 transition-colors cursor-pointer">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <span className="text-2xl font-light text-slate-900">{metrics?.totalCandidates || 0}</span>
                                    </div>
                                    <h4 className="font-semibold text-slate-900 text-sm">Bench Candidates</h4>
                                ...
                                <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between hover:border-slate-300 transition-colors cursor-pointer">
                                    <div className="flex justify-between items-start mb-4">
                                        ...
                                        <span className="text-2xl font-light text-slate-900">{metrics?.placements || 0}</span>
                                    </div>
                                    <h4 className="font-semibold text-slate-900 text-sm">Active Placements</h4>
                        ...
                        <div className="space-y-6">
                            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest">Financial Pipeline</h3>
                            
                            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-6">
                                <div>
                                    <div className="flex items-center gap-3 text-slate-600 mb-2">
                                        <DollarSign size={16} />
                                        <span className="text-sm font-semibold">Projected Revenue</span>
                                    </div>
                                    <div className="text-3xl font-light text-slate-900">₹{((metrics?.revenue || 0) / 1000).toFixed(1)}K</div>
                                    <p className="text-xs text-emerald-600 font-medium mt-1">Based on active placements</p>
                                </div>
